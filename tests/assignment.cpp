...
{
  xyz::copy_on_write<xyz::indirect<int>> a(99);
  xyz::copy_on_write<xyz::indirect<int>> b(0);
  b = a;
...
TEST(Assignment, CopyAssignmentFromValuelessMakesTargetValueless)
{
  ...
  xyz::copy_on_write<xyz::indirect<int>> c(5);
  c = a;
...
{
  xyz::copy_on_write<xyz::indirect<int>> a(3);
...
{
  xyz::copy_on_write<xyz::indirect<int>> a(4);
  xyz::copy_on_write<xyz::indirect<int>> b(0);
  b = std::move(a);
...
{
  xyz::copy_on_write<xyz::indirect<int>> a(1);
  xyz::copy_on_write<xyz::indirect<int>> b(std::move(a)); // a valueless
  xyz::copy_on_write<xyz::indirect<int>> c(5);
  c = std::move(a);
  EXPECT_TRUE(c.valueless_after_move());
}
...
{
  xyz::copy_on_write<xyz::indirect<int>> x(1);
  int const* ptr = &(*x);
  x = 42;
  EXPECT_EQ(*x, 42);
...
{
  xyz::copy_on_write<xyz::indirect<std::string>> x("old");
  x = std::string("new");
  EXPECT_EQ(*x, "new");
}
